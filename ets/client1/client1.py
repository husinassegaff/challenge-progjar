...
def recv_msg(sock):
    while True:
        ...
        # Response client untuk perintah LIST
        if data == '3':
        ...
        # Response client untuk perintah DOWNLOAD
        elif data == '4':
